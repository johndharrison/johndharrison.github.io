...
map$setView(c(53.2,-6.15), zoom = 1)
...
<font size="2">ggplot2 example on running on shiny server on digital ocean</font>
...
another example
<font size="2">RSelenium testapp running on shiny server on digital ocean</font>
